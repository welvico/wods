...
"传奇剧场"=>"C8000000000000000001586755568202",
"热血剧场"=>"C8000000000000000001586755334304",
"往昔剧场"=>"C8000000000000000001681195984396",
"生活剧场"=>"C8000000000000000001587975283115",
"怀旧经典"=>"C8000000000000000001681196041195",
"放映厅"=>"C8000000000000000001659935357556",
"梨园戏曲"=>"C8000000000000000001681695523229",
"红色经典"=>"C8000000000000000001681368925801",
...
if (isset($data['info']) && is_array($data['info'])) {
    ...
    //echo $content ;
    // 使用 file_put_contents() 将 $content 写入到 B.xml 文件
    file_put_contents('B.xml', $content);
